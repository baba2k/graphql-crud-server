...
type GraphQLListener interface {
	...
	// EnterObjType is called when entering the objType production.
	EnterObjType(c *ObjTypeContext)
	...
	// ExitObjType is called when exiting the objType production.
	ExitObjType(c *ObjTypeContext)
